  ...
  private initializeDataTable(): void {
    this.dataTable = $('#tasks-table').DataTable({
      ...
      columns: [
        ...
        {name: "script", render: (data) => `<div class="scrollable code">${data}</div>`, orderable: false},
        ...
        {name: "module", orderable: false},
        {name: "container", render: (data) => `<span class="inline code">${data}</span>`, orderable: false},
        {name: "disk", orderable: false},
        {name: "attempt", orderable: false},
        {name: "scratch", orderable: false},
